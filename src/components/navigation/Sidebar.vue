...
const { buttons, activeButton, isSidebarOpen } = defineProps({
...
<template>
    <div>
        <Transition name="sidebar">
            <div class="sidebar" v-if="isSidebarOpen" @wheel.prevent="" @touchmove.prevent="">
                <div class="navbar">
                    <v-btn elevation="0" icon="mdi-close" @click="$emit('close')" />
                </div>
