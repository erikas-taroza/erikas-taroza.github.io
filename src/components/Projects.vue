...
const projects = [
  {
    ...
    image_urls: [bitbeat1, bitbeat2, bitbeat3, bitbeat4],
    project_url: "",
  },
  {
    name: "simple_audio",
  ...
  },
  {
    name: "audiotags",
    description:
      "A Flutter plugin for reading and writing metadata tags on audio files.",
    image_urls: [],
  ...
  },
  {
    ...
    description:
      "A piece of documentation for making a Flutter plugin using Rust.",
    image_urls: [],
  ...
  },
  {
    name: "SpotifyAntiAd",
    description:
      "A Windows program that skips Spotify ads by closing and reopening the client.",
    image_urls: [spotifyAntiAd],
    project_url: "https://github.com/erikas-taroza/SpotifyAntiAd",
  },
  {
    name: "EmailSpamCleaner",
    description:
      "An app that helps you clean your inbox and unsubscribe from emails.",
    image_urls: [emailSpamCleaner],
    ...
    <div class="projects">
      <div v-for="project in projects">
        <v-card
          ...
          elevation="2"
          @click="
            project.project_url ? onProjectClicked(project.project_url) : null
          "
        >
