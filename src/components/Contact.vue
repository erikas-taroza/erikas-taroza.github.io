    ...
    <div class="container">
        ...
        <v-card class="card" elevation="2">
            ...
            <v-form ref="formRef">
                ...
                <v-text-field v-model="subject" density="comfortable" label="Subject" :rules="[validateInput]" />

                <v-textarea v-model="message" density="comfortable" label="Message" :rules="[validateInput]" />
            </v-form>
            ...
            <v-btn
                ...
                @click="onSendMessage()"
                :disabled="
                    validateInput(subject) !== true || validateInput(message) !== true || validateEmail(from) !== true
                "
            >
                Send Message
            </v-btn>
            ...
            <div style="display: flex; justify-content: center">
                ...
                />
                <p
                    v-else-if="(sendState == SendState.Success || sendState == SendState.Error) && result.length > 0"
