...
<template>
    <div>
        <v-btn
            class="btn"
            icon="mdi-github"
            :color="!flat ? 'primary' : 'rgba(0, 0, 0, 0)'"
            :elevation="!flat ? 3 : 0"
            width="40"
            height="40"
            @click="openLink('https://github.com/erikas-taroza')"
        >
            <v-icon :color="!flat ? 'white' : '#4B4B4B'">mdi-github</v-icon>
        </v-btn>
        ...
        <v-btn
            ...
            width="40"
            height="40"
            @click="openLink('https://discord.gg/BDFfAZdpAb')"
        >
            <div style="height: 24px; width: 24px; margin-right: 2px;">
                <svg :fill="!flat ? 'white' : '#4B4B4B'" viewBox="0 0 32 32" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
...
<style scoped>
    .btn {
        margin-left: v-bind("!flat ? '7px' : '4px'");
        margin-right: v-bind("!flat ? '7px' : '4px'");
    }
